...
namespace DGM.Controllers
{
    public class EstadosController : Controller
    {
        ...
        public EstadosController(DGMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstado,Descripion,FechaCreacion")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstado,Descripion,FechaCreacion")] Estado estado)
        {
